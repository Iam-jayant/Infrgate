  ...
  return (
    ...
    >
      ...
      <div ref={headerRef} className="mb-16">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">About</h2>
      </div>
      ...
      <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-4xl">
        ...
        <div className="col-span-1 md:col-span-2">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">About the Project</h4>
          <p className="font-mono text-xs text-foreground/80 leading-relaxed max-w-md">
