...
const signals = [
  {
    ...
    note: "One API for all major LLM providers. Zero code changes required.",
  },
  {
    date: "FEATURE.02",
    title: "Token Rate Limiting",
    note: "Sliding window rate limits using Redis for extreme precision.",
  },
  {
    date: "FEATURE.03",
    title: "Idempotency",
    note: "Prevent duplicated requests from double billing your upstream providers.",
  },
  {
    date: "FEATURE.04",
    title: "Granular Tenancy",
    note: "Manage multiple tenants with independent spend caps and permissions.",
  },
  {
    date: "FEATURE.05",
    title: "Edge Routing",
    note: "Smart fallback and failover across model providers during outages.",
  },
]
